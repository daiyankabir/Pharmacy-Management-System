...
public class RemoveCompanyGUI extends JFrame
{
    
    private Container c;
	private ImageIcon icon;
	private JPanel panel1, panel2;
	public RemoveCompanyGUI()
	{   
		...
		//Label
		JLabel header= new JLabel("Remove Company");
		...
		//button
		JButton button1 = new JButton("Remove Company");
		...
		button1.addActionListener((ActionEvent a) -> {
                    ...
                    controller.removeCompanyByName(tf2.getText());
					dispose();
